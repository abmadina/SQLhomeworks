...
select o.OrderID, c.LastName, c.FirstName from Orders as o
join customers as C
...
select e.Name, d.DepartmentID from Departments as D
join Employees as E
on e.DepartmentID=d.DepartmentID
...
s.ProductID from Customers as c
inner join sales as s
on c.CustomerID=s.CustomerID
where s.SaleAmount>500
group by c.FirstName, c.LastName ,s.ProductID
...
select p.Amount,o.Quantity*pr.Price as QuantityonPrice from Payments as p
...
select e1.Salary,e1.EmployeeID, e1.Name, e1.Salary from Employees as e1
